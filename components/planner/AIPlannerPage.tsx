...
import AIPlannerIcon from '../common/icons/AIPlannerIcon';
...
const AIPlannerPage: React.FC<AIPlannerPageProps> = ({ messages, onSendMessage, onResetChat, isLoading, currentUser, onFileUpload, currentFile, onRemoveFile }) => {
    ...
    return (
        <div className="h-full flex flex-col">
            <header className="flex-shrink-0 flex items-center justify-between p-4 z-10 sticky top-0 border-b" style={{
                ...
                <h1 className="text-xl font-bold" style={{ color: 'var(--color-text-primary)' }}>AI Planner</h1>
                <button 
                    onClick={onResetChat}
